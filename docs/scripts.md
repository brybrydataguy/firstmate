...
| `fm-update.sh`           | Fast-forward-only self-update of firstmate and local or remote secondmate homes; [self-update remotes](configuration.md#self-update-remotes-configupstream-remote) owns the optional fork reconciliation |
