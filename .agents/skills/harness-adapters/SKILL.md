...
Firstmate launches every verified worker adapter inside a durable task process scope and proves that scope empty before an agy transition changes wiring or teardown touches the worktree.
