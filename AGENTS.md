...
config/upstream-remote  optional git remote name of the authoritative upstream when this home follows a personal fork as origin; LOCAL, gitignored, and not inherited; absent keeps the classic single-remote self-update; see docs/configuration.md "Self-update remotes"
